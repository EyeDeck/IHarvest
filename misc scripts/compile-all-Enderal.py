...
mo2_dir = "C:/Bethesda Softworks/Mod Organizer EnderalSE/mods/"
mo2_SSE_dir = "C:/Bethesda Softworks/MO2 SSE Mods/"
dirs_to_compile = [mo2_dir + "IHarvest EnderalSE/Source/Scripts"] #["C:\Program Files (x86)\Steam\SteamApps\common\Skyrim Special Edition"]
output_dir = "../../Scripts"
game_dir = "C:/Program Files (x86)/Steam/SteamApps/common/Skyrim Special Edition"
scripts_dir = game_dir + "/Data/Source/Scripts"
extra_source_dirs = [mo2_SSE_dir + "SkyUI 5.1 SDK/Source/Scripts", mo2_SSE_dir + "Harvest Overhaul Redone/Source/Scripts", mo2_SSE_dir + "doticu_skypal/Source/Scripts"]
compiler = game_dir + "/Papyrus Compiler/PapyrusCompiler.exe"
flags = game_dir + "/Papyrus Compiler/TESV_Papyrus_Flags.flg"
prefix = "IH_"
debugs = [("Debug.", ";~bug."), ("IH_Util.Trace", ";~_Util.Trace")]
...
for dir in dirs_to_compile:
	...
	for file in files:
		...
		if prefix in file and file[-4:] == ".psc":
			...
			args = [compiler, file, "-i=" + scripts_dir + ";" + dir + ";" + extra_dirs, "-o=" + output_dir, "-f=" + flags, "-q"]
			#for a in args:
			#	print(a)
