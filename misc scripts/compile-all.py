...
mo2_dir = "C:/Bethesda Softworks/MO2 SSE Mods/"
dirs_to_compile = [mo2_dir + "IHarvest/Source/Scripts"] #["C:\Program Files (x86)\Steam\SteamApps\common\Skyrim Special Edition"]
output_dir = "../../Scripts"
game_dir = "C:/Program Files (x86)/Steam/SteamApps/common/Skyrim Special Edition"
scripts_dir = game_dir + "/Data/Source/Scripts"
extra_source_dirs = [mo2_dir + "SkyUI 5.1 SDK/Source/Scripts", mo2_dir + "Harvest Overhaul Redone/Source/Scripts", mo2_dir + "doticu_skypal/Source/Scripts"]
