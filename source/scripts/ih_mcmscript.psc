...
Event OnPageReset(string a_page)
	if (a_page == "")
		...
		SetCursorPosition(17) ; right of "Maintenance" header
		AddHeaderOption("")
		OIDreset = AddTextOption("$Reset Mod", "[ ]")
...
Event OnOptionDefault(int a_option)
	...
	elseif (a_option == OIDhf)
		...
		IH_PersistentData.v10102_UpdateHFSetting()
		SetToggleOptionValue(a_option, IH_LearnHearthfire.GetValue() as bool)
	elseif (a_option == OIDspawnDist)
	...
	elseif (a_option == OIDmagickadrain)
		OnOptionSliderAccept(a_option, 8.0)
	elseif (a_option == OIDquestmode)
		IH_SearchMode.SetValue(0.0)
		IH_PersistentData.v10200_SetDefaultSearchMode()
		OnOptionMenuAccept(a_option, IH_SearchMode.GetValue() as int)
	endif
EndEvent
